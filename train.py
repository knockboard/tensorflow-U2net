...
def load_dataset(path, split=0.2):
    train_x = sorted(glob(os.path.join(path, "images", "train", "*.png")))
    train_y = sorted(glob(os.path.join(path, "masks", "train", "*.png")))
...
if __name__ == "__main__":
    ...
    # dataset root path
    dataset_path = "./data"  # Set the working directory as the dataset path
